...
// +kubebuilder:webhook:path=/validate-qubership-org-v3-sitemanager,mutating=false,failurePolicy=fail,sideEffects=None,groups=qubership.org,resources=sitemanagers,verbs=create;update,versions=v3,name=vsitemanager-v3.kb.io,admissionReviewVersions=v1,servicePort=442
