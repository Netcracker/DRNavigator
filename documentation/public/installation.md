...
|----------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|
| crd.install                                                    | Enable/disable site-manager CRD installation. CRDs are required for site-manager to function — if disabled, they must be installed manually before deploying the chart. Disabled by default to support environments where the deploying user has restricted cluster-level permissions. | false                          |
