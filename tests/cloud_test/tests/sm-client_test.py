...
class SMTestCase:
    ...
    def test_activate_all_sites(self, config_dir, sm_env, config_ingress_service, capfd):
    ...
    def test_passivate_all_sites(self, config_dir, sm_env, config_ingress_service, capfd):
    ...
    def test_maintenance_standby_site(self, config_dir, sm_env, config_ingress_service, capfd):
    ...
    def test_return_first_site(self, config_dir, sm_env, config_ingress_service, capfd):
