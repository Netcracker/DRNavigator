...
def check_status_from_service(service_name, service_url, expected_status, token):
    headers = {
    ...
    logging.debug(f"Check status from service {service_name} in site, received: {service_status}")
