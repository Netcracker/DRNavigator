...
class MaintenanceReturnTestCase:
    ...
    def test_maintenance_second_service(self, config_dir, caplog):
    ...
    def test_return_second_service(self, config_dir, caplog):
    ...
    def test_maintenance_first_service(self, config_dir, caplog):
    ...
    def test_return_first_service(self, config_dir, caplog):
